...
class HealthVitalsCollectionViewCell: UICollectionViewCell {
    ...
    override func prepareForReuse() {
      ...
      private func styleStaticLabels() {
          ...
          heartRateTitle.font = UIFont.systemFont(ofSize: 16, weight: .semibold)
      ...
      func configureCell(avgHeartRate: String,peakHeartRate: String,respiratoryRate: String,peakRespiratoryRate: String,theme:AppTheme) {
          self.theme = theme
          containerView.backgroundColor = theme.glassMedium
          containerView.layer.borderWidth = 1
          containerView.layer.cornerRadius = 16
          containerView.layer.borderColor = theme.glassBorderLight as! CGColor
          peakTitle.text = "Peak"
          heartRateTitle.text = "Heart Rate (Avg)"
          beatsPerMinTitle.text = avgHeartRate
          peakRespiratoryTitle.text = "Peak"
          peakBeatsPerTitle.text = peakHeartRate
          respiratoryRateTitle.text = "Respiratory Rate"
          breathsPerMinLabel.text = respiratoryRate
          PeakRespiratoryRateLabel.text = peakRespiratoryRate
          applyTheme()
      }
  }
