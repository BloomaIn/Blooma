...
class ProfileViewController: UIViewController {
    ...
    func generateLayout() -> UICollectionViewLayout {
        ...
        return UICollectionViewCompositionalLayout { sectionIndex, _ in
            ...
            let group = NSCollectionLayoutGroup.vertical(layoutSize: groupSize, subitem: item, count: sectionType.rows.count)
...
extension ProfileViewController {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if sectionType == .header {
            ...
            cell.configure(name: profile.name, nickname: profile.userName, image: profile.profileImageData, theme: theme)
