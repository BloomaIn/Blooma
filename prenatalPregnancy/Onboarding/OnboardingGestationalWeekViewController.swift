...
class OnboardingGestationalWeekViewController: UIViewController {
    ...
    private func configureUI() {
        ...
        subtitleLabel.text = "Choose LMP or due date for accurate tracking"
        ...
        dateHelpLabel.font = .systemFont(ofSize: 13, weight: .regular)
        dateHelpLabel.numberOfLines = 0
        dateHelpLabel.textAlignment = .center
