...
class RoutineViewController: UIViewController {
    ...
    private var routineCache: [RoutineType: [RoutineItem]] = [:]
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        print(dataController.progressStore)
        loadTodayRoutine()
    ...
    private func loadTodayRoutine() {
        ...
        todaySession = dataController.getTodayRoutineSummary(for: date)
        
        routineCache.removeAll()
        
        for session in todaySession {
            let items = routineCache[session.routineType] ?? []
            routineCache[session.routineType] = items
        }
