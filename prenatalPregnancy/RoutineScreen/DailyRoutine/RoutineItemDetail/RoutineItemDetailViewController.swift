...
extension RoutineItemDetailViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.section == 0 {
            ...
            cell.configure(image: routineItem.image, videoName: videoName, elapsed: progress.elapsedSeconds, total: totalDurationSeconds, theme: theme, accent: accent, mode: mode)
        ...
        case .benefits:
            ...
            cell.configurePoint(text, theme: dataModel.theme)
