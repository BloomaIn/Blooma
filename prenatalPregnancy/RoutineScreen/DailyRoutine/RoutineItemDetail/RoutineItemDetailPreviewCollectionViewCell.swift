...
class RoutineItemDetailPreviewCollectionViewCell: UICollectionViewCell {
    ...
    func configure(image: String, videoName: String, elapsed: Int, total: Int, theme: AppTheme, accent: UIColor,  mode: RoutineControlMode) {
        cleanupPlayer()
        ...
        previewImageView.image = resolvedImage(named: image)
        previewImageView.alpha = 1
        videoView.alpha = 0
