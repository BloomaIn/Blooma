...
class HomeViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    private func registerCells() {
        pregnancyCollectionView.register(
            UINib(nibName: "TopCollectionViewCell", bundle: nil),
    ...
    private func topCardSection() -> NSCollectionLayoutSection {
        let size    = NSCollectionLayoutSize(widthDimension: .fractionalWidth(1.0), heightDimension: .absolute(170))
    ...
    private func routineSection() -> NSCollectionLayoutSection {
        ...
        section.visibleItemsInvalidationHandler = { [weak self] visibleItems, offset, environment in
            ...
            let page = max(0, Int(round(offset.x / environment.container.contentSize.width * CGFloat(self.routineCards.count))))
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case 1:
            ...
            if let item = card.firstIncompleteItem {
                ...
                cell.configureCell(with: item, progress: progress, index: index , theme:theme)
            } else {
                ...
                cell.configureCell(with: anyItem, progress: doneProgress, index: card.totalCount, theme: theme)
            }
            return cell
